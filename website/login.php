...
<div class="cont">
    <div class="form sign-in">
      ...
      <form method="post" action="login.php" id="sign_in_form">
        ...
        <label id="email">
          <span>Email</span>
          <input type="email" name="email" id="signin_email" placeholder="johnsmith@medipol.edu.tr" required pattern="(.+@medipol.edu.tr)|(.+@st.medipol.edu.tr)" title="Please enter an email with Medipol extension" /><br>
        </label>
        <label>
          <span>Password</span>
        ...
        <button class="submit" id="sign_in" name="log_user">Sign In</button>
        <a href = "AdminLogin.php"><button type="button" class="fb-btn"><span>Continue as admin</span></button></a>
      </form>
    </div>
  ...
  <div class="sub-cont">
    ...
    <div class="form sign-up">
      ...
      <form method="post" action="login.php" id="register_form">
        ...
        <label>
          <span>Email</span>
            <input type="email" name="email" id="signup_email" placeholder="johnsmith@medipol.edu.tr" required pattern="(.+@medipol.edu.tr)|(.+@st.medipol.edu.tr)"
        ...
        <button class="submit" name="reg_user" onclick="Validate()" >Sign Up</button>
      </form>
    </div>
  </div>
</div>
